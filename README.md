...
- [Boytacean](https://github.com/joamag/boytacean) - A GameBoy emulator written in Rust that works in the Browser using WebAssembly ([Demo](https://boytacean.joao.me))
